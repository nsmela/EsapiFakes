...
namespace VMS.TPS.Common.Model.API
{
    ...
    {
        public PlanSetup() { }
        public void GetProtocolPrescriptionsAndMeasures(List<ProtocolPhasePrescription> prescriptions, List<ProtocolPhaseMeasure> measures) { }
        public ReferencePoint AddReferencePoint(bool target, Nullable<VVector> location, string id)  => default;
        public bool IsValidForPlanApproval(List<PlanValidationResultEsapiDetail> validationResults)  => default;
        ...
        public bool GetCalculationOption(string calculationModel, string optionName, string optionValue)  => default;
        ...
        public bool SetTargetStructureIfNoDose(Structure newTargetStructure, StringBuilder errorHint)  => default;
